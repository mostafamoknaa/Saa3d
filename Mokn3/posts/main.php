              ...
              <div class="mt-3 col-md-8 col-12">
                <div class="card border-light mb-3">
                  ...
                  <div class="card-footer d-flex">
                      ...
                      <div class="mx-auto">
                        <a class = "ms-auto" href="posts.php?id=<?php echo rawurlencode($row['post_id']); ?>"><i class="viewIcon fa fa-comments-o fa-2x"></i></a>
                      </div>
                      <div class="mx-auto">
              ...
              <?php
                ...
                if(mysqli_num_rows($res)>0){
                    while($row = mysqli_fetch_assoc($res)){?>
                        ...
                        <a href="\mokn3/users/profile.php?uid=<?php echo rawurlencode($row['user_id']); ?>"><span class="text-black h6"><?php echo $row['user_name']?></span></a>
