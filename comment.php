...
?>
          ...
          <div class="card border-light mb-3">
            <div class="mainPost">
              <div class="card-header d-flex justify-content-between border-bottom">
                <a href="profile.php?uid=<?php echo rawurlencode($user_id); ?>"><span class="text-danger h5">@
                <?php
                $post_id=$_GET['id'];
                $userid="SELECT user_id FROM posts WHERE post_id=$post_id;";
                $qry_data = mysqli_query($con, $userid);
            ...
            while($coments = mysqli_fetch_assoc($result)){?>
              <div class="card-footer">
               <div class="d-flex justify-content-between">
                <a href="profile.php?uid=<?php echo rawurlencode($coments['user_id']); ?>"><span class="text-danger h6">@
                <?php
    ...
    <script>
    <?php
    include('C:\AppServ\www\saa3d\javascripts\post.js');
    ?>
    </script>
    <?php } ?> 
